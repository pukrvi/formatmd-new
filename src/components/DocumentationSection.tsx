  ...
  const sections: Section[] = [
    {
      ...
      features: [
        ...
        {
          icon: <Lock className="w-4 h-4" style={{ color: c.heading }} />,
          title: 'Synced Scroll',
          description: 'In Split view, the editor and preview scroll together by default — toggle the lock in the toolbar.',
          details: ['Locked by default', 'Proportional scroll', 'Toggle to unlock'],
        },
      ],
    },
    {
